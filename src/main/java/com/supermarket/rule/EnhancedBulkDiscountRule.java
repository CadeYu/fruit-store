 ...
 * 支持BigDecimal精确计算和灵活的阈值配置
 * 
 * @author SupermarketPricingSystem
 * @version 2.0
 */
public class EnhancedBulkDiscountRule implements EnhancedPricingRule {
    
    /** 被装饰的基础定价规则 */
    private final EnhancedPricingRule basePricingRule;
     ...
     */
    public EnhancedBulkDiscountRule(final EnhancedPricingRule basePricingRule) {
     ...
     * @return 基础规则
     */
    public EnhancedPricingRule getBasePricingRule() {
     ...
     * 验证基础定价规则的有效性
     */
    private void validateBasePricingRule(final EnhancedPricingRule basePricingRule) {
